  ...
  return (
    <Dialog.Root open={open} onOpenChange={() => onStart()}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-surface-900/80 backdrop-blur-sm border border-surface-800 rounded-xl max-w-lg w-[90vw] max-h-[80vh] overflow-auto p-6 space-y-6 mx-4 text-center z-50">
